        ...
        <form className="space-y-5" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div>
            ...
            <input
              ...
              className={`w-full border ${errors.name ? "border-red-500" : "border-gray-300"} rounded-md px-3 py-2 focus:outline-none focus:border-teal-700 focus:ring-1 focus:ring-teal-700`}
            />
          ...
          <div>
            ...
            <input
              ...
              className={`w-full border ${errors.email ? "border-red-500" : "border-gray-300"} rounded-md px-3 py-2 focus:outline-none focus:border-teal-700 focus:ring-1 focus:ring-teal-700`}
            />
          ...
          <div>
            ...
            <input
              ...
              className={`w-full border ${errors.password ? "border-red-500" : "border-gray-300"} rounded-md px-3 py-2 focus:outline-none focus:border-teal-700 focus:ring-1 focus:ring-teal-700`}
            />
          ...
          <div>
            ...
            <input
              ...
              className={`w-full border ${errors.confirmPassword ? "border-red-500" : "border-gray-300"} rounded-md px-3 py-2 focus:outline-none focus:border-teal-700 focus:ring-1 focus:ring-teal-700`}
            />
          ...
          <div>
            ...
            <textarea
              ...
              className={`w-full border ${errors.address ? "border-red-500" : "border-gray-300"} rounded-md px-3 py-2 focus:outline-none focus:border-teal-700 focus:ring-1 focus:ring-teal-700 resize-none`}
            />
